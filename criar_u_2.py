...
with app.app_context():
    ...
    # 1️⃣ EMPRESA 2
    # =====================================================
    empresa = Empresa.query.filter_by(nome="stvhd2").first()
    ...
    if not admin:
        ...
        print("✅ Usuário admin2 criado (empresa vinculada)")
    else:
        print("ℹ️ Usuário admin2 já existe para esta empresa")

    # =====================================================
    # 3️⃣ LICENÇA DA EMPRESA 2
    # =====================================================
    ...
    db.session.commit()
    print("✅ Permissões atribuídas ao usuário admin2.")
